...
const variantClasses = (variant) => ({
    "bg-primary text-white hover:bg-secondary focus:ring-primary":
        variant == "primary",
    "bg-white text-gray-500 hover:bg-gray-100 focus:ring-secondary dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200":
        variant == "secondary",
